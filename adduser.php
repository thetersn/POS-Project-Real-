...
if (isset($_POST['singup'])) {
    ...
    if (empty($firstname)) {
        ...
        $_SESSION['error'] = 'รหัสผ่านต้องมีความยาวระหว่าง 5-30';
        header("location: index.php");
    } else if (empty($c_password)) {
        $_SESSION['error'] = 'กรุณากรอกรหัสผ่านอีกครั้ง';
        header("location: index.php");
        ...
        try{
            ...
            if($row['email'] == $email){
                $_SESSION['warning'] = "มีอีเมลอยู่แล้ว <a href='signin.php'>คลิ๊กที่นี่</a>";
